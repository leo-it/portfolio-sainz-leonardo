...
const ReactQuery = () => {
  ...
  return (
    <>
      ...
      >
        <AlertDialogSlide  name={"Descripcion de seccion"} title={"Practica de React Query"} description={"React Query es una librería que cuenta con 2 sencillos hooks que proporcionan la obtención, el almacenamiento en caché y la actualización de datos asíncronos en las aplicaciones React."}/>
